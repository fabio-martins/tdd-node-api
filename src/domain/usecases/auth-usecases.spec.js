...
describe('Auth Usecase', () => {
    ...
    test('Should call TokenGenerator with correct userId', async () => {
        const { sut, loadUserByEmailRepositorySpy, encrypterSpy, tokenGeneratorSpy } = makeSut()
        await sut.auth('valid_email@mail.com', 'valid_password')
        expect(tokenGeneratorSpy.userId).toBe(loadUserByEmailRepositorySpy.user.id)
    })

    test('Should return an accessToke if valid credencial are provided', async () => {
    ...
    test('Should call UpdateAcessTokeRepository with correct values', async () => {
    ...
    test('Should throw if invalid dependencies are  provide ', async () => {
